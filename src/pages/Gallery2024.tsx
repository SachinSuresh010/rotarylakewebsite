...
const Gallery2024: React.FC = () => {
  usePageTitle('Gallery 2024-2025');
  
  const [selectedYear, setSelectedYear] = useState<string | null>(null);

  const events = getEventsByYear("2024-2025");
